...
/* harmony export */ });
/* harmony import */ var _background_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../background/actions */ "./src/background/actions.js");
...
function onMessage (message) {
  switch (message.type) {
    case _shared_consts__WEBPACK_IMPORTED_MODULE_2__.MESSAGES.RECEIVE_IMAGES_URLS:
      break;
...
function sendImageUrl (e) {
  ...
  if (url || originalPictureHref) {
    browser.runtime.sendMessage({
      type: _shared_consts__WEBPACK_IMPORTED_MODULE_2__.MESSAGES.RECEIVE_ORIGINAL_URL,
      title: document.title,
      url,
      originalPictureHref,
      href: document.location.href,
      reason: _shared_consts__WEBPACK_IMPORTED_MODULE_2__.EXTRACTION_REASON.DOWNLOAD,
    });
  }
}

function extractSrc (el) {
  const specialRule = (0,_background_actions__WEBPACK_IMPORTED_MODULE_0__.getSpecialRule)(
